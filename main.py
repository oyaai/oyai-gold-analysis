...
def show_summary(price, news, score):
    ...
    if score > 0:
        ...
        print("⚠️ คำแนะนำ: ชะลอการซื้อ รอจังหวะราคาย่อตัวลงมาอีก")
    else:
        print("💡 มุมมอง: [กลาง] ตลาดทรงตัว")
        print("⚖️ คำแนะนำ: ซื้อสะสมตามแผนปกติ (ถัวเฉลี่ย)")
    print("="*50 + "\n")
...
def main():
    ...
    if score > 0:
        ...
        recommendation = "⚠️ แนะนำ: ชะลอการซื้อ (ข่าวเป็นลบ)"
        est_range = f"{current_sell - 300:,} - {current_sell + 100:,}"
    else:
        recommendation = "⚖️ แนะนำ: ถือครอง/ซื้อถัวเฉลี่ย (ตลาดนิ่ง)"
